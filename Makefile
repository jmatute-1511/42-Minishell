...
#    Updated: 2022/05/31 14:49:47 by jmatute-         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

SRCS	= 	minishell.c built_echo.c built_pwd.c built_cd.c initialize_vars.c fts_lst.c \
			ft_lst2.c built_export.c built_unset.c built_env.c list_cmds.c utils.c expansions.c \
			quotes.c filter_list_cmds.c boleans_first_errors.c acces_cmds.c
